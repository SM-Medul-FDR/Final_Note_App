...
//--------------------remove
 ...
 const[popColoreCode , setPopColoreCode] = useState('2')
  ...
  return (
    <>
         ...
         <div className="flex flex-wrap md:gap-5 gap-4  ">
            ...
            <Popup showValue={showPopup} popCross={()=>setShowPopup(false) } editDataValue={editData}  popColorToken={popColoreCode} />
    </>
  )
}
