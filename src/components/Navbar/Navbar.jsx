...
// ----------- Redax Data import
  ...
  return (
    <>
        <nav className=" relative  shadow-indigo-500/50 py-1 px-1 md:px-6 dark:bg-[#202124] bg-[#fff] border-b-[1px] border-gray-300 flex justify-between transition-all duration-[.2s] ">
           <Link to='/'>
            <div className="logo flex items-center font-Monstarait font-bold dark:text-white transition-all duration-[.2s]"><img src="images/logo2.png" alt="logo" className=' h-[35px] ' />ThinkNote <span className=' md:text-[8px] text-[7px] absolute bottom-1 md:bottom-[8px] left-[33.5px] md:left-[4.2%] font-nunito '>Medul™</span> </div>
           </Link>
