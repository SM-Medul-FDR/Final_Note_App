...
const Popup = ({showValue , popCross , editDataValue , popColorToken}) => {
// -------------------- Redax Data -----------------------------
                ...
                <div className=" relative pr-[180px] mt-2 md:mt-3 overflow-hidden ">
                    <div className=" flex gap-4   ">
                        ...
                        <div className="PopupCustomColor">
                            <label htmlFor={"PopupCustomC"+popColorToken}  >
                            <FaPenFancy className=' PopupCustomColorIcon  ' />
                            </label>
                        <input onChange={(e)=>{setColors(e.target.value)}} className='hidden' id={'PopupCustomC'+popColorToken } type="color" />
                        </div>
                        </div>
                    </div>
                </div>
...
<div className=" relative pr-[180px] mt-2 md:mt-0 overflow-hidden ">
    <div className=" flex gap-0   ">
        ...
        <div className={`PopupColors absolute bottom-0 flex gap-1 ${showColore? 'left-10' : 'left-[-195px]' } `}>  
            ...
            <div className="PopupCustomColor">
                    <label htmlFor={"PopupCustomCt"+popColorToken} >
                    <FaPenFancy className=' PopupCustomColorIcon  ' />
                    </label>
                <input onChange={(e)=>setFontColor(e.target.value)} className='hidden' id={'PopupCustomCt'+popColorToken} type="color" />
            </div>
...
<div className=" relative pr-[180px] mt-2 md:mt-3 overflow-hidden ">
    <div className=" flex gap-4   ">
        ...
        <div className={`PopupColors absolute bottom-0 flex gap-1 ${showColore? 'left-10' : 'left-[-195px]' } `}>
            ...
            <div className="PopupCustomColor">
                    <label htmlFor={"PopupCustomCn"+popColorToken} >
                    <FaPenFancy className=' PopupCustomColorIcon  ' />
                    </label>
                <input onChange={(e)=>setNoteColor(e.target.value)} className='hidden' id={'PopupCustomCn'+popColorToken} type="color" />
            </div>
        </div>
    </div>
</div>
